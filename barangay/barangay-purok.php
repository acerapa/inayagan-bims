...
<body>
  ...
  <div id="pcoded" class="pcoded">
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                        <h5 class="m-b-10">Manage Purok</h5>
                                        <p class="m-b-0 js-city-brgy-name-hjagxcvsfder">Barangay, City</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                    <button class="btn btn-primary" onclick="showAddPurok()">Add Purok</button>
                                  </div>
                              </div>
                          </div>
                      </div>
    ...
    <script type="text/javascript" src="../assets/js-custom-brgy/barangay-purok.js"></script>
</body>
